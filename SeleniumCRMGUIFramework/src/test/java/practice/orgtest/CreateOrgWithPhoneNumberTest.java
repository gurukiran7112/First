...
public class CreateOrgWithPhoneNumberTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		// read comman data from jason file
		...
		String actOrtgName = driver.findElement(By.id("dtlview_Organization Name")).getText();
		if (actOrtgName.equals(orgName)) {
			System.out.println(actOrtgName + "information is created===Fail");
		} else {
