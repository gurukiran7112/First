...
/* program to close only main window and all the child windows ( provide !(not eual symbol ) to close all windows and remove to close main window)*/
...
public class p8 {
	...
	public static void main(String[] args) {
		...
		for (String lv : allWindows) {
			...
			if (!title.contains("Selenium Grid Online")) {
				driver.close();
